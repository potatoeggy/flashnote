...
public class ApiService {
    ...
    private final static String DROPBASE_CARD_PIPELINE = "ceL5HS6BSP5Rv6AqyD6jS4";
    private final static String DROPBASE_MAP_PIPELINE = "";
    private final static String DROPBASE_TAG_PIPELINE = "";
    private final static String DROPBASE_USER_PIPELINE = "";
